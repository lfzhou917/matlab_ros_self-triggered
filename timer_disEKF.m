...
%  tarxtrue=1.62;
%  tarytrue=-0.566;
 tarx_hat=[1.58, 1.58, 1.58, 1.58, 1.58, 1.58];
 tary_hat=[-0.285, -0.285, -0.285, -0.285, -0.285, -0.285];
...
posesub_4 = rossubscriber('/robot_4/pose');
posesub_5 = rossubscriber('/robot_5/pose');
posesub_tar = rossubscriber('/robot_6/pose');

%

t = timer('TimerFcn',{@sixrobot_periodic_disEKF},...
